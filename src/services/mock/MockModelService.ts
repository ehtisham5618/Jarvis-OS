...
const CATALOG: ModelRecord[] = [
  {
    id: "llama3.1:8b", name: "Llama 3.1", variant: "8B Instruct", developer: "Meta",
    parameters: "8B", contextLength: 128000, vramRequired: 6, ramRequired: 10, quantization: "Q4_K_M",
  ...
  {
    id: "qwen2.5-coder:7b", name: "Qwen 2.5", variant: "Coder 7B", developer: "Alibaba",
    parameters: "7B", contextLength: 32000, vramRequired: 5, ramRequired: 8, quantization: "Q4_K_M",
    installed: false, recommended: false,
    vision: false, embeddings: false, reasoning: true, coding: true, multilingual: true,
  },
  {
    id: "deepseek-r1:70b", name: "DeepSeek R1", variant: "Distill 70B", developer: "DeepSeek",
    parameters: "70B", contextLength: 65536, vramRequired: 48, ramRequired: 56, quantization: "Q4_K_M",
    installed: false, recommended: true,
    vision: false, embeddings: false, reasoning: true, coding: true, multilingual: false,
  },
  {
    id: "mistral:7b", name: "Mistral", variant: "7B Instruct", developer: "Mistral AI",
    parameters: "7B", contextLength: 32000, vramRequired: 5, ramRequired: 8, quantization: "Q4_K_M",
    installed: false, recommended: false,
    vision: false, embeddings: false, reasoning: false, coding: true, multilingual: true,
  },
  {
    id: "phi4:14b", name: "Phi 4", variant: "14B", developer: "Microsoft",
    parameters: "14B", contextLength: 16000, vramRequired: 10, ramRequired: 16, quantization: "Q4_K_M",
    installed: false, recommended: false,
    vision: false, embeddings: false, reasoning: true, coding: true, multilingual: false,
  },
  {
    id: "nomic-embed-text:latest", name: "Nomic Embed", variant: "Text v1.5", developer: "Nomic",
    parameters: "137M", contextLength: 8192, vramRequired: 1, ramRequired: 2, quantization: "F32",
    installed: false, recommended: true,
    vision: false, embeddings: true, reasoning: false, coding: false, multilingual: true,
  },
];
...
export class MockModelService implements IModelService {
  ...
  async getModels(): Promise<ModelRecord[]> {
    ...
    return CATALOG.map(m => {
      ...
      const ollamaInstalled = installedIds.some(id => id === m.id || id.startsWith(m.id.split(":")[0]));
