...
export const Route = createFileRoute("/lock")({
  head: () => ({
    meta: [{ title: "Locked · Jarvis" }, { name: "description", content: "Lock screen with ambient briefing." }],
  }),
  component: Lock,
});
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-between px-12 py-16">
        ...
        <div className="text-center">
          ...
          <div className="glass mx-auto mt-10 max-w-lg rounded-2xl p-5 text-left">
            <div className="mb-2 text-[10px] uppercase tracking-widest text-muted-foreground">Ambient briefing</div>
            <p className="text-sm font-light leading-relaxed text-white/85">
              14° and clear in London. 3 meetings today, first at 10am with the design team.
              Aether build passed. Battery at 87%.
            </p>
          </div>
        </div>
        <Link
        ...
        >
          ...
          <span className="text-xs text-muted-foreground">Touch to unlock · or say "Hey Jarvis"</span>
        </Link>
      </div>
    </div>
  );
