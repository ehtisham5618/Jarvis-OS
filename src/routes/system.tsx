...
export const Route = createFileRoute("/system")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Live hardware telemetry, temperature, and process intelligence.",
      },
    ],
  }),
  component: System,
  ...
  return (
    <div className="relative rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6">
      <div className="flex items-center justify-between">
        ...
        <div
          className="size-1.5 animate-pulse rounded-full shadow-[0_0_6px_currentColor]"
        ...
        <div className="mt-8 flex items-start gap-4 rounded-2xl border border-[#61c7ff]/20 bg-[#61c7ff]/[0.04] p-5">
          ...
          <div className="flex-1">
            ...
            <div className="mt-1 text-xs text-muted-foreground">
              Node modules from 12 abandoned projects, build caches from Blender, and 8 old iOS
              simulators are safe to remove.
            </div>
          </div>
...
function MiniStat({
  ...
  return (
    <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5">
      ...
      <div className="mt-2 text-xl font-light tabular-nums" style={{ color }}>
        {value}
      </div>
      ...
      <div className="mt-3 h-1 overflow-hidden rounded-full bg-white/[0.05]">
        <div
          ...
          style={{ width: `${bar}%`, background: color, boxShadow: `0 0 6px ${color}` }}
        />
      </div>
    </div>
  );
